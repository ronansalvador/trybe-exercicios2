...
// passando o segundo parametro como 0
...
//passando o segundo parametro como 10
...
// somar todos os numeros pares do array
// utilizando filter e reduce

const numbers = [18, 19, 23, 53, 4, 5, 76, 23, 54];

const verificaPar = (numero) => numero % 2 === 0;
const somaPar = (inicial, numero) => inicial + numero;

const somaNumeroPar = (array) => array.filter(verificaPar).reduce(somaPar)

console.log(somaNumeroPar(numbers));


// utilizando apenas o reduce
